...
document.getElementById('mobile-login-btn').addEventListener('click', handleMobileLogin);
document.getElementById('mobile-signup-btn').addEventListener('click', handleMobileSignUp);
...
function handleMobileSignUpMobile() {
  ...
  const repeatPassword = document.getElementById('mobile-signup-repeat-password').value;
